						...
						<div id="usernameicon" class="px-1">
							...
							<div id="logoutdiv">
								<div class="d-flex justify-content-center">
									<a href="doctorlogout.html"><h6>Doctor Logout</h6></a>
								</div>
							</div>
...
<!--  -->
 <div>
 			<br><div>
					...
					<div class="d-flex justify-content-center">
            <br><hr> 
            <form method="get" action="${pageContext.request.contextPath}/UpdateInDoctors">
                <table id="tab">
                    <tr>
                        <td>Name</td>
                        <td><input type="text" name="name" value="<%=dd.getName()%>" placeholder="<%=dd.getName()%>"  class="form-control" pattern="[a-zA-Z ]*"></td>
                    </tr>
                    <tr>
                        <td>Phone</td>
                        <td><input type="text" name="phone" value="<%=dd.getPhone()%>" placeholder="<%=dd.getPhone()%>" class="form-control" pattern="[0-9]{10}"></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td><input type="text" name="email" value="<%=dd.getEmail()%>" placeholder="<%=dd.getEmail()%>"  class="form-control" readonly></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td><input type="password" name="password" value="<%=dd.getPassword()%>" placeholder="<%=dd.getPassword()%>"  class="form-control" pattern="(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}"></td>
                    </tr>
                    <tr><%} %>
                        <td>Department</td>
                        <td>
                    ...
                    <tr>
                         <td colspan="2" class="text-center"><input type="submit" name="Update Doctor" name="Update Doctor" class="form-control"></td>
                    </tr>
                </table>
            </form>
            </div>
