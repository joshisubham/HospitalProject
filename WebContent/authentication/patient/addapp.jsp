...
<div>
				<br><div>
					...
					<div class="d-flex justify-content-center">
            <form method="get" action="${pageContext.request.contextPath}/PatientAddAppointments">
            
                <table>
                    <tr>
                        <td>Appointment Date</td>
                        <td><input type="date" name="appdate"  class="form-control" min required></td>
                    </tr>
                    <tr>
                        <td colspan="2"><input type="hidden" name="pid" value="<%=id%>"></td>
                    ...
                    <tr>
                         <td colspan="2" class="text-center"><input type="submit" name="Add Patient"  class="form-control"></td>
                    </tr>
                </table>
            </form>
            </div>
